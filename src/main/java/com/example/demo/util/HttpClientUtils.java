...
public class HttpClientUtils {
    ...
    public static Object doPost(String url, Map<String, String> params) throws IOException {
        return JSON.parseObject(doPost(url, params, CHARSET));
    }
    ...
    public static void main(String[] args) {
        System.out.println(doGet("http://baike.baidu.com/api/openapi/BaikeLemmaCardApi?scope=103&format=json&appid=379020&bk_key=%E9%93%B6%E9%AD%82&bk_length=600", null));
    }
}